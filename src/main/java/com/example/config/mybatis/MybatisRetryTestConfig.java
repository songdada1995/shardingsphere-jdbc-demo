...
@Configuration
@MapperScan(basePackages = MybatisRetryTestConfig.SCAN_PACKAGE, sqlSessionFactoryRef = MybatisRetryTestConfig.BEAN_SQL_SESSION_FACTORY_NAME)
public class MybatisRetryTestConfig {

    /* 多数据原配置 - 修改开始 */
    static final String SCAN_PACKAGE = "com.example.dao.retrytest";
    static final String MAPPER_LOCATION = "classpath*:mapper/retrytest/*.xml";
    static final String DATA_SOURCE_PROPERTIES_PREFIX = "spring.datasource.retry-test";
    static final String BEAN_NAME_PREFIX = "retryTest";
    /* 多数据原配置 - 修改结束 */
    ...
    public SqlSessionFactory sqlSessionFactory(
        ...
        //设置mapper location
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver().getResources(MybatisRetryTestConfig.MAPPER_LOCATION));
